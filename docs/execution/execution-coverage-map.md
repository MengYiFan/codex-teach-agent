...
| 6.0 教师快速生成入口 | `product/prd-teacher-quick-start.md`、`technical/trd-api-and-data-contracts.md` | 页面流程、字段策略、快速生成 API。 |
...
| 8 后端接口设计 | `technical/trd-api-and-data-contracts.md` | 快速生成 API 和完整接口清单。 |
...
| 13 测试策略 / 质量评估 | `technical/trd-security-and-testing.md`、`reference/content-quality-rubric.md` | 测试类型、质量指标。 |
...
本轮补齐后，原总稿中“文件解析、完整接口、数据库、仓库模块、模型配置、广场与 Agent、产物生成细节”等首次拆分时偏薄的部分，均已有对应分层文档承接。
